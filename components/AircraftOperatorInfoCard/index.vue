<template>
  <div class="box pilot-info-card">
    <div class="avatar" @click="onClickPhoto">
      <img
        v-if="aircraftOperator.aircraftOperatorImage"
        :src="aircraftOperator.aircraftOperatorImage"
        alt="Pilot Photo" class="pilot-photo" 
      />
    ...
    <div class="date">
     {{ aircraftOperator.aircraftOperatorFiscalName }}
    </div>
