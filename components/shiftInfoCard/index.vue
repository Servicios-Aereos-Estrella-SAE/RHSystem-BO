<template>
  <div class="box shift-info-card">
    <div class="shift-name">
      {{ `${shift.shiftName}` }}
    </div>

    <div class="buttons"  v-if="showEditButton">
      <button v-if="showEditButton && canUpdate" class="btn" @click="handlerClickOnEdit">
      ...
      <button v-if="showDeleteButton && canDelete" class="btn" @click="handlerClickOnDelete">
