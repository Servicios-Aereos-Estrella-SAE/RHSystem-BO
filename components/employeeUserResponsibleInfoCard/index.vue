<template>
  <div class="employee-user-responsible-info-card">
    <div>
      <div v-if="userResponsibleEmployee.user" class="employee-user-responsible">
        <div class="capitalize">
          User:
          {{ userResponsibleEmployee.user.userEmail }}
        </div>
      </div>
    </div>
