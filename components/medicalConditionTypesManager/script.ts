...
export default defineComponent({
  ...
  name: 'MedicalConditionTypesManager',
  emits: ['close', 'medicalConditionTypeCreated'],
  setup() {
  ...
  methods: {
    ...
    async onSaveMedicalConditionType(medicalConditionType: MedicalConditionTypeInterface) {
      ...
      // Emitir evento si es un nuevo tipo
      if (isNewType) {
        this.$emit('medicalConditionTypeCreated', medicalConditionType)
      }
    }
  }
})
