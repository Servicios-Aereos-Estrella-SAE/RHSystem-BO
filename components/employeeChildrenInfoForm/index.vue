      ...
      <div class="form-container">
        ...
        <div class="input-box">
          ...
          <Dropdown v-model="employeeChildren.employeeChildrenGender" :options="genders" optionLabel="label"
            optionValue="value" placeholder="Select Gender" class="w-full md:w-14rem" :disabled="isDeleted" />
        ...
        <div class="input-box">
          <div class="hire-date-box-container">
            ...
            <div v-if="!displayChildrenBirthDateCalendar" class="hire-date-box">
              <InputText v-model="childrenBirthday" readonly class="capitalize" :disabled="isDeleted" />
              <Button type="button" class="btn btn-block" id="display-input-hiredate"
                @click="handlerDisplayChildrenBirthDate" :disabled="isDeleted">
