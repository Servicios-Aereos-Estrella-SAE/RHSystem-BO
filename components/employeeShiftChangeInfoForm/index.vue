      ...
      <div class="form-container">
        ...
        <div class="input-box">
          <div class="date-box-container">
            <label>Date to</label>
            <div v-if="!displayDateToCalendar" class="date-box">
            ...
            <div v-if="displayDateToCalendar" class="date-box-controller">
              <Calendar v-if="displayDateToCalendar" dateFormat="yy-mm-dd"
                ...
                :maxDate="maxDate" :invalid="submitted && !employeeShiftChange.employeeShiftChangeDateTo" />
              <Button type="button" class="btn btn-block" id="display-input-expiration-at"
                @click="displayDateToCalendar = false">
                <svg fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <small class="p-error" v-if="submitted && !employeeContract.employeeShiftChangeDateTo">Date to
              is required.
            </small>
          </div>
        </div>
