<template>
  <div class="box system-setting-payroll-config-info-card">
    ...
    <div
      v-if="systemSettingPayrollConfig.systemSettingPayrollConfigPaymentType === 'biweekly' || systemSettingPayrollConfig.systemSettingPayrollConfigPaymentType === 'specific_day_of_month'"
      class="info status">
