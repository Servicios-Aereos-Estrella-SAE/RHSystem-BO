<template>
  <div v-if="isReady" class="box employee-shifts">
    ...
    <div class="head-calendar">
      ...
      <nuxt-link v-if="!displayInputCalendar" :to="`/employees-attendance-monitor/${this.employee.employeeCode}`"
        target="_blank" title="Assist report" class="btn btn-block">
        <svg fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <path
  ...
  <transition name="page">
    <shiftExceptionsError v-if="drawershiftExceptionsError" :shiftExceptions="shiftExceptionsError"
