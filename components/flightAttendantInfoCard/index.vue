<template>
  <div class="box flight-attendant-info-card">
    <div class="avatar" @click="onClickPhoto">
      <img v-if="flightAttendant.flightAttendantPhoto" :src="flightAttendant.flightAttendantPhoto" alt="Flight Attendant Photo" class="flight-attendant-photo" />
     ...
     <div class="name">
      {{ formatName(flightAttendant.employee.employeeFirstName) }}
      {{ formatName(flightAttendant.employee.employeeLastName) }}
    </div>
