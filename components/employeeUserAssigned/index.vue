  ...
  <div v-if="isReady" class="employee-user-assigned">
    <div v-if="isReady" class="employee">
      <div class="form-container">
        ...
        <div class="card flex justify-content-center">
          <Sidebar v-model:visible="drawerEmployeeSelection" header="User" position="right"
            class="employee-user-assigned-selection-sidebar" :showCloseIcon="true">
            <employeeUserAssignedSelection :employee="employee" @onUserAssignedEmployeeSave="onSaveSelection" />
          </Sidebar>
        </div>
      </div>
    </div>
