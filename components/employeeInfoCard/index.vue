<template>
  <div class="box user-info-card">
    <div v-if="employee.employeePhoto" class="avatar-photo" @click="onClickPhoto">
      <img :src="employee.employeePhoto" alt="Employee Photo" class="employee-photo" />
    </div>
    <div v-else class="avatar" @click="onClickPhoto">
