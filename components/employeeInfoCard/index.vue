<template>
  <div class="box user-info-card">
    ...
    <div class="box-tools-footer">
      ...
      <button v-if="canUpdate && (canReadOnlyFiles || canManageFiles)" id="btn-procceding-files" class="btn btn-block" @click="handlerOpenProceedingFiles" >
      ...
      <button v-if="canDelete && !employee.deletedAt" class="btn btn-block" @click="handlerClickOnDelete">
