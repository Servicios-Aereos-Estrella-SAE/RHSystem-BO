<template>
  <div class="dialog-confirm-vacation-authorization">
    <div class="content-wrapper">
      <div class="content">
        ...
        <div class="title">
          {{ $t('are_you_sure_you_want_to_authorize_vacations') }}
        </div>
        <p class="description">
          {{ $t('if_you_continue_with_this_action_vacation_requests_will_be_authorized') }}
          <br>
          <br>
          {{ $t('type_the_word') }}
        ...
        <InputText v-model="verifyWord" class="uppercase text-center" @keyup.enter="handlerConfirmAuthorization" />
