  ...
  <div class="shift-exception-info-card">
    ...
    <div>
      <div class="shift-name">
        <div v-if="exceptionRequest.exceptionType && exceptionRequest.exceptionType.exceptionTypeTypeName"
          class="shift-name">
        </div>
        <div v-if="exceptionRequest.exceptionTypeId">
          {{ getExceptionTypeName(exceptionRequest.exceptionTypeId) }}
        </div>
      </div>
      <div class="description">
        <div v-if="exceptionRequest.exceptionRequestsDescription">
          {{ exceptionRequest.exceptionRequestsDescription }}
        </div>
        <div v-if="exceptionRequest.requestedDate">
          {{ calendarDay }}
        </div>
    ...
    <div v-if="exceptionRequest.exceptionType && !isDeleted" class="box-tools-footer">
      ...
      <Button v-if="canManageUserResponsible && canManageCurrentDay" class="btn btn-block"
    ...
    <div v-if="!exceptionRequest.exceptionType && !isDeleted && canManageException" class="box-tools-footer">
      ...
      <Button
        v-if="exceptionRequest.exceptionRequestStatus === 'pending' && canManageUserResponsible && canManageCurrentDay"
