      ...
      <div class="input-text-row input-text-row-reservation-leg">
        ...
        <div class="input-box required">
          ...
          <span class="icon" :class="{'translate-30': isSubmitted && !reservationLeg.reservationLegDepartureTime}">
            ...
            <InputText :disabled="editMode && !canUpdate" type="time" v-model="reservationLeg.reservationLegDepartureTime" />
        ...
        <div class="input-box required">
          ...
          <Dropdown :disabled="editMode && !canUpdate" filter v-model="reservationLeg.airportDestinationId" :options="formatAirports" optionLabel="customName" optionValue="airportId"
        ...
        <div class="input-box required">
          ...
          <InputText :disabled="editMode && !canUpdate" type="number" v-model="reservationLeg.reservationLegPax" placeholder="3" />
        ...
        <div class="input-box required">
          ...
          <InputText :disabled="editMode && !canUpdate" type="number" v-model='reservationLeg.reservationLegDistanceMn' placeholder="MN" />
