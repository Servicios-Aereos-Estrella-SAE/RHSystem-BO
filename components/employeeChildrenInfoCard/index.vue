<template>
  <div class="box employee-children-info-card">
    <div class="name">
      {{ `${employeeChildren.employeeChildrenFirstname || ''}` }}
    ...
    <div class="box-tools-footer">
      ...
      <Button v-if="canDelete && canManageUserResponsible" class="btn" @click="handlerClickOnDelete">
        <svg fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <path
