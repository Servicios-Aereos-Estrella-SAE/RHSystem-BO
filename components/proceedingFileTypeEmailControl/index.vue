<template>
  <div class="proceeding-file-type-email-control">
    ...
    <div v-else class="form-date">
      <InputText v-model="currentProceedingFileTypeEmail.proceedingFileTypeEmailEmail" placeholder="Enter email" :invalid="submitted && (!currentProceedingFileTypeEmail.proceedingFileTypeEmailEmail || isEmailInvalid)" />
