<template>
  <div v-if="isReady" class="employee-work-disabilities">
    ...
    <div class="work-disabilities-wrapper">
      <div class="head-page">
        <div class="input-box">
          <Button v-if="displayAddButton && canManageUserResponsible" class="btn btn-block" @click="addNew">
    ...
    <div v-if="isReady">
      <div v-if="workDisabilities.length > 0" class="work-disabilities-wrapper">
        <div v-for="(workDisability, index) in workDisabilities" :key="`work-disability-${index}`">
          <workDisabilityInfoCard :isDeleted="isDeleted" :work-disability="workDisability"
            ...
            :canManageWorkDisabilities="canManageWorkDisabilities" :canManageUserResponsible="canManageUserResponsible"
            :employee="employee" />
        </div>
      </div>
