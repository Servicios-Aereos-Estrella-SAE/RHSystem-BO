<template>
  <div class="dialog-confirm-assist">
    <div class="content-wrapper">
      <div class="content">
        ...
        <div class="title">
          {{ $t('are_you_sure_you_want_to_save_assist') }}

        </div>
        <p class="description">
          <b class="assist-time">{{ formatAssistTime }}</b>
          <br>
          <br>
          {{ $t('if_you_continue_with_this_action_the_assist_will_be_saved') }}
          <br>
          <br>
          {{ $t('type_the_word') }}
        ...
        <InputText v-model="verifyWord" class="uppercase text-center" @keyup.enter="handlerConfirmSave" />

        <p v-if="isIncorrect" class="incorrect">
          {{ $t('incorrect_value_to_confirm') }}
        </p>
        <div class="tools">
          <Button class="btn btn-block btn-info" @click="handlerConfirmSave">
            {{ $t('confirm') }}
          </Button>
