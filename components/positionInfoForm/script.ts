      ...
      if (
        ...
        try {
          ...
          if (response.status === 200 || response.status === 201) {
            ...
            const departmentPositionResponse = await departmentService.assignDepartment(position, departmentId);
            ...
            this.$toast.add({
              severity: 'error',
              summary: 'Error',
              detail: 'There was an error saving the position: ' + response._data.data.sqlMessage,
              life: 10000
            });
