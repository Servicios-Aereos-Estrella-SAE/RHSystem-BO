<template>
  <div class="caledar-day">
    <div v-if="isReady">
      ...
      <div class="tools">
        <Button v-if="displayButtonManageShift" id="btn-open-shift-form" class="btn btn-block"
          @click="handlerShiftForm(employeeCalendar)" :disabled="isDeleted || !canManagementShift">
        ...
        <Button v-if="displayButtonManageExceptions" id="btn-open-exceptions" class="btn btn-block"
          @click="handlerClickExceptions" :disabled="!employeeCalendarAssist.assist.dateShift">
          <svg fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
