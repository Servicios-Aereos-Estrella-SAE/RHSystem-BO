<template>
  <div class="caledar-day">
    <div v-if="isReady">
      <div v-if="isDirectlyAssignedShift && canRemoveShiftAssigned" class="icons" @click="handlerClickOnDelete">
      ...
      <div class="tools">
        <Button v-if="displayButtonManageShift && canManageUserResponsible" id="btn-open-shift-form"
          class="btn btn-block" :disabled="isDeleted || !canManagementShift"
        ...
        <Button v-if="displayButtonManageExceptions" id="btn-open-exceptions" class="btn btn-block"
          :class="{ active: employeeCalendar.assist.hasExceptions }"
          :disabled="!employeeCalendarAssist.assist.dateShift" @click="handlerClickExceptions">
          <svg fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <Button v-if="displayButtonManageShiftChanges" class="btn btn-block"
          :class="{ active: employeeCalendar?.assist?.dateShift?.shiftIsChange }"
          :disabled="!employeeCalendarAssist.assist.dateShift" @click="handlerClickShiftChanges">
          <svg fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <Button v-if="displayCancelEditShiftButton" id="btn-cancel-shift-form" class="btn btn-block"
