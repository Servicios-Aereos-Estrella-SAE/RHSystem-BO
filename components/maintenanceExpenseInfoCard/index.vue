<template>
  <div class="box expense-info-card">
    <div class="name">
      {{ `Category: ${maintenanceExpense.maintenanceExpenseCategory.maintenanceExpenseCategoryName}`  }}
    </div>
    <div class="line"></div>
    <div class="maintenance-number">
      {{ `Tracking Number: ${maintenanceExpense.maintenanceExpenseTrackingNumber}` }}
    </div>

    <div class="maintenance-number">
      {{ `Internal Folio: ${maintenanceExpense.maintenanceExpenseInternalFolio}` }}
    </div>
    <Tag severity="secondary" :value="formattedAmount" class="p-mr-2">
    </Tag>
