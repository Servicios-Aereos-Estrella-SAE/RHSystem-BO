<template>
  <div class="vacation-control">
    ...
    <div v-if="!displayForm" class="read-date">
      ...
      <Button class="btn btn-block" @click="onEdit" :disabled="!canManageVacation">
      ...
      <Button class="btn btn-block" @click="handlerClickOnDelete()" :disabled="!canManageVacation">
    ...
    <div v-else class="form-date">
      ...
      <Button class="btn btn-block" @click="handlerClickOnSave()" :disabled="!canManageVacation">
      ...
      <Button class="btn btn-block" @click="cancelEdit" :disabled="!canManageVacation">
