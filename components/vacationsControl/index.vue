<template>
  <div class="vacation-control">
    ...
    <div v-if="!displayForm" class="read-date">
      ...
      <Button class="btn btn-block" @click="onEdit" :disabled="!canManageVacation || isDeleted || (shiftException.shiftExceptionId && !canManageToPreviousDays)">
      ...
      <Button class="btn btn-block" @click="handlerClickOnDelete()" :disabled="!canManageVacation || isDeleted || (shiftException.shiftExceptionId && !canManageToPreviousDays)">
