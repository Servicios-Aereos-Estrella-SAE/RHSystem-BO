<template>
  <div class="vacation-control">
    ...
    <div v-if="!displayForm" class="read-date">
      ...
      <Button class="btn" @click="handlerClickOnDelete()" v-if="displayDestroyVacationDayButton">
    ...
    <div v-else class="form-date">
      ...
      <Button class="btn" @click="handlerClickOnSave()" :disabled="!canManageVacation || isDeleted">
      ...
      <Button class="btn" @click="cancelEdit" :disabled="!canManageVacation || isDeleted">
