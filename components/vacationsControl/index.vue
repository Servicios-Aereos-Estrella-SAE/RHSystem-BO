<template>
  <div class="vacation-control">
    ...
    <div v-if="!displayForm" class="read-date">
      ...
      <Button class="btn btn-block" @click="onEdit" :disabled="!canManageVacation || isDeleted || (shiftException.shiftExceptionId && !canManageToPreviousDays) || !canManageException">
      ...
      <Button class="btn btn-block" @click="handlerClickOnDelete()" :disabled="!canManageVacation || isDeleted || (shiftException.shiftExceptionId && !canManageToPreviousDays) || !canManageException">
    ...
    <div v-else class="form-date">
      ...
      <Button class="btn btn-block" @click="handlerClickOnSave()" :disabled="!canManageVacation || isDeleted">
      ...
      <Button class="btn btn-block" @click="cancelEdit" :disabled="!canManageVacation || isDeleted">
