<template>
  <div class="itinerary-info-form">
    <Toast />
    <div v-if="true" class="itinerary-form">
      <div class="input-text-row">
        ...
        <div class="input-box required">
          ...
          <InputText type="date" placeholder="04/03/24" />
        </div>
        <div class="input-box required">
          ...
          <InputText type="time" placeholder="00:00" />
        </div>
        <div class="input-box required">
          <label for="someField" class="input-label">
            To
        ...
        <div class="input-box required">
          ...
          <InputText type="date" placeholder="04/05/24" />
        </div>
        <div class="input-box">
          <label for="someField" class="input-label">
            (24hrs)
        ...
        <div class="input-box required">
          ...
          <InputText type="number" placeholder="3" />
        </div>
      </div>
    </div>
    <div class="input-text-row">
        <div class="input-box required">
          ...
          <InputText type="time" placeholder="MMTC" />
        </div>
        <div class="input-box required">
          <label for="someField" class="input-label">
            Distance (NM)
          ...
          <InputText type="numeric" placeholder="MNx" />
        </div>
        <div class="input-box required">
