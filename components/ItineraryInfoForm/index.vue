    ...
    <div class="itinerary-form">
      <div class="input-text-row input-text-row-reservation-leg">
        <div class="input-box required">
          ...
          <Dropdown filter v-model="reservationLeg.airportDepartureId" :options="formatAirports" optionLabel="customName" optionValue="airportId"
        ...
        <div class="input-box required">
          ...
          <!-- <Calendar
              ...
              placeholder="00:00"
            /> -->
            <InputText type="time" v-model="reservationLeg.reservationLegDepartureTime" />
        ...
        <div class="input-box required">
          ...
          <Dropdown filter v-model="reservationLeg.airportDestinationId" :options="formatAirports" optionLabel="customName" optionValue="airportId"
        ...
        <div class="input-box">
          ...
          <span class="icon translate5" :class="{'translate-30': isSubmitted && !reservationLeg.reservationLegArriveTime}">
            ...
            <InputText type="time" v-model="reservationLeg.reservationLegArriveTime" />
        ...
        <div class="input-box required">
          ...
          <InputText type="number" v-model="reservationLeg.reservationLegPax" placeholder="3" />
        ...
        <div class="input-box required">
          ...
          <span class="icon translate5" :class="{'translate-30': isSubmitted && !reservationLeg.reservationLegTravelTime}">
            ...
            <InputText type="time" v-model="reservationLeg.reservationLegTravelTime" />
        ...
        <div class="input-box required">
          ...
          <InputText type="number" v-model='reservationLeg.reservationLegDistanceMn' placeholder="MN" />
        ...
        <div class="input-box required">
          <div class="btn-group btn-group-with-stops mt-5">
            ...
            <button v-if="isLast" class="btn btn-middle" @click="addLeg()">
              <span class="icon">
