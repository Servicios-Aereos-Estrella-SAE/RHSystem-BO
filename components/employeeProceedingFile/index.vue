      ...
      <div class="form-container">
        ...
        <div class="employee-proceeding-file-wrapper">
         ...
         <div class="card flex justify-content-center">
          <Sidebar v-model:visible="drawerEmployeeProceedingFileForm" position="right" class="employee-proceeding-file-form-sidebar" :showCloseIcon="true">
            <employeeProceedingFileInfoForm :employeeProceedingFile="employeeProceedingFile" @onEmployeeProceedingFileSave="onSave" />
          </Sidebar>
        </div>
      </div>
      <Dialog v-model:visible="drawerEmployeeProceedingFileDelete" :style="{width: '450px'}" header="Confirm" :modal="true">
