<template>
  <div class="card-container" @click="toggleMenu(false)">
    ...
    <div class="card-content">
      <div class="description">{{ document.proceeding_file_name }}</div>
      <div class="details">
        <span> Name: {{ document.employee_name }}</span>
        <span> UUID: {{ document.proceeding_file_type_name }} {{ document.proceeding_file_identify }}</span>
