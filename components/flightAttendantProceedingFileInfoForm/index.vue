<template>
  <div class="box flight-attendant-proceeding-file-info-form">
    <Toast />
    <h4>
      {{ isNewFlightAttendantProceedingFile ? 'New flight attendant proceeding file' : 'Update flight attendant proceeding file' }}
    </h4>
    <div v-if="isReady" class="flight-attendant-proceeding-file-form">
      <div class="form-container">
        ...
        <div class="input-box">
          ...
          <Calendar v-model="proceedingFile.proceedingFileExpirationAt" dateFormat="yy-mm-dd"
            @update:model-value="formatDate('proceedingFileExpirationAt')" />
        </div>
        <div class="input-box">
        ...
        <div class="input-box">
          ...
          <Calendar v-model="proceedingFile.proceedingFileSignatureDate"
            @update:model-value="formatDate('proceedingFileSignatureDate')" dateFormat="yy-mm-dd" />
        </div>
        <div class="input-box">
          <label for="proceedingFileEffectiveStartDate">Effective start date</label>
          <Calendar v-model="proceedingFile.proceedingFileEffectiveStartDate"
            @update:model-value="formatDate('proceedingFileEffectiveStartDate')" dateFormat="yy-mm-dd" />
        </div>
        <div class="input-box">
          <label for="proceedingFileEffectiveEndDate">Effective end date</label>
          <Calendar v-model="proceedingFile.proceedingFileEffectiveEndDate"
            @update:model-value="formatDate('proceedingFileEffectiveEndDate')" dateFormat="yy-mm-dd" />
        </div>
        <div class="input-box">
          <label for="proceedingFileInclusionInTheFilesDate">Inclusion in the files date</label>
          <Calendar v-model="proceedingFile.proceedingFileInclusionInTheFilesDate"
            @update:model-value="formatDate('proceedingFileInclusionInTheFilesDate')" dateFormat="yy-mm-dd" />
        </div>
        <div class="input-box">
