<template>
  <div class="box aircraft-info-card">
    ...
    <div class="box-tools-footer">
      <nuxt-link v-if="canUpdate" :to="`/aircraft/${aircraft.aircraftId}`" class="btn btn-block" @click="handlerClickOnGallery">
