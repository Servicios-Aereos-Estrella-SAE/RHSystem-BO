          ...
          <div class="guest-form">
            <div class="form-container">
              ...
              <div class="input-box">
                ...
                <Password v-model="newPassword" toggleMask promptLabel="---" :weakLabel="$t('weak')"
                  :mediumLabel="$t('medium')" :strongLabel="$t('strong') ">
                  <template #header>
                    <h6>{{ $t('enter_the_new_password') }}</h6>
                  </template>
                  <template #footer>
                    <Divider />
                    ...
                    <Button :label="$t('generate')" severity="secondary" @click="generatePassword()" />
                  </template>
                </Password>
              </div>
              <div class="input-box">
              ...
              <Button v-ripple :label="$t('confirm')" class="btn-block" @click="handlerNewPasswordRequest" />
            </div>
          </div>
        </div>
      </div>
