  ...
  <div>
    <div class="employees-page">
      ...
      <NuxtLayout name="backoffice">
          ...
          <div class="filters">
            ...
            <div class="buttons-group">
              <div class="employee-limit-container">
                ...
                <Button v-if="canCreate" class="btn" @click="openExcelImporter">
        ...
        <!-- Excel Importer Sidebar -->
        <Sidebar v-model:visible="drawerExcelImporter" :blockScroll="true" :closeOnEscape="false" :dismissable="false"
          :header="$t('excel_import')" position="right" class="employee-sidebar-forms" :showCloseIcon="true"
          @hide="onExcelImporterHide">
          <employeeExcelImporter @save="onSave" />
        </Sidebar>
