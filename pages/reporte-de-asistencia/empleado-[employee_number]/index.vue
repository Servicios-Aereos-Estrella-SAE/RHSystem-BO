    ...
    <NuxtLayout name="backoffice">
      <div class="dashboard-wrapper">
        ...
        <div class="box report-wrapper">
          <div class="head">
            <h2>
              Entradas y Salidas - JUNIO, 2024
            </h2>
          </div>
          <div class="days-wrapper">
            <div v-for="i in 31" :key="`period-day-month-${i}`">
              <div v-if="i === 15" class="day holiday">
                <div class="date">
              ...
              <div v-else-if="i >= 20 && i <= 23" class="day vacation">
                <div class="date">
                  {{ i.toString().padStart(2, '0') }}
                  <small>
                    ( Lunes )
