<template>
  <div class="dashboard-page">
    ...
    <Head>
      <Title>
        {{ $t('all_departments_attendance_monitor') }}
      </Title>
    </Head>
    <NuxtLayout name="backoffice">
      <div v-if="isReady" class="dashboard-wrapper">
        <div class="title">
          <h1>
            {{ $t('general_departments_attendance_monitor') }}
          </h1>
        </div>
        ...
        <div class="box departments-excel-report-buttons">
        ...
        <div v-if="canDisplayFrontExcel" class="box departments-excel-report-buttons from-api">
